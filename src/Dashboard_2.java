...
this.setVisible(true);
   ...
   public void Connect(){
    ...
    private void initComponents() {
        ...
        jLabel10.setText("CANDIDATE MANAGEMENT");
    ...
    private void jLabel9MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MousePressed
        ...
        try {
            int c;
            if(m.isSelected())
            sql="UPDATE CANDIDATES SET FIRSTNAME=?,LASTNAME=?,AGE=?,GENDER='M' WHERE ID=?";
            if(f.isSelected())
            sql="UPDATE CANDIDATES SET FIRSTNAME=?,LASTNAME=?,AGE=?,GENDER='F' WHERE ID=?";
            ...
            if(m.isSelected())
            ql="UPDATE USERS SET FIRSTNAME=?,LASTNAME=?,AGE=?,GENDER='M' WHERE ID=?";
            if(f.isSelected())
            ql="UPDATE USERS SET FIRSTNAME=?,LASTNAME=?,AGE=?,GENDER='F' WHERE ID=?";
            pstmt=con.prepareStatement(sql);
            pstmt.setInt(4,Integer.parseInt(id) );
            pstmt.setString(1, fn);
            pstmt.setString(2, ln);
        ...
        } catch (SQLSyntaxErrorException ex2) {
            JOptionPane.showMessageDialog(null, "Please enter all fields", "Missing fields", JOptionPane.ERROR_MESSAGE);
        }
        catch (SQLException ex) {
            Logger.getLogger(Dashboard.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jLabel8MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MousePressed
        ...
        try {
            ...
            if(c>0){
                ...
                JOptionPane.showMessageDialog(null, "Make sure you enter valid candidate information.", "Invalid information", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (SQLException ex) {
            Logger.getLogger(Dashboard.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jLabel7MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MousePressed
        ...
        try {
            int c;
            if(m.isSelected())
            sql="INSERT INTO CANDIDATES VALUES(?,?,?,?,'M',0)";
            if(f.isSelected())
            sql="INSERT INTO CANDIDATES VALUES(?,?,?,?,'F',0)";
            pstmt=con.prepareStatement(sql);
            pstmt.setInt(1,Integer.parseInt(id) );
            ...
            JOptionPane.showMessageDialog(null, "This id already exists", "Duplicate ID", JOptionPane.ERROR_MESSAGE);
        }
        catch (SQLSyntaxErrorException ex2) {
            JOptionPane.showMessageDialog(null, "Please enter all fields", "Missing fields", JOptionPane.ERROR_MESSAGE);
        }
